...
void onInit(CSprite@ this)
{
	...
	for (int i = 0; i < count; i++)
	{
		...
		CSpriteLayer@ tracer=this.addSpriteLayer("tracer" + i, (this.getBlob().exists("gun_tracerName") ? this.getBlob().get_string("gun_tracerName") : "Lasgun_Tracer.png"),32,1,this.getBlob().getTeamNum(),0);
