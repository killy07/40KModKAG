...
shared class BloodthirsterInfo
{
	u8 stun;
	u8 actionTimer;
	u8 attackDelay;
...
//shared attacking/bashing constants (should be in BloodthirsterVars but used all over)
