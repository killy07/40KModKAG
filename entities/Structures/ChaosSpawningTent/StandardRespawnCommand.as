...
void InitClasses(CBlob@ this)
{
	...
	addPlayerClass(this, "Bloodthirster", "$knight_class_icon$", "bloodthirster", "Hack and Slash.");
	addPlayerClass(this, "Ultramarine", "$archer_class_icon$", "ultramarine", "The Ranged Advantage.");
}
