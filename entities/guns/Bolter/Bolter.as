...
void onInit(CBlob@ this)
{
	...
	settings.TOTAL = 36; //Max amount of ammo that can be in a clip
	settings.FIRE_INTERVAL = 2; //Time in between shots
	settings.RELOAD_TIME = 45; //Time it takes to reload (in ticks)
	settings.AMMO_BLOB = "mat_stone"; //Ammunition the gun takes
	...
	settings.B_DAMAGE = 5.0f; //1 is 1 heart
	...
	//Sound
	settings.FIRE_SOUND = "bolterfiring"; //Sound when shooting
	//.RELOAD_SOUND = "SMGReload.ogg"; //Sound when reloading
