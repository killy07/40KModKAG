...
class Bullet
{
    ...
    bool onTick(CMap@ map)
    {
        ...
        if (map.getHitInfosFromRay(OldPos, Angle, CurrentVelocity.Length(), hoomanShooter, @list))
        {
            ...
            const string S_FLESH_HIT  = gunBlob.exists("CustomSoundFlesh")  ? gunBlob.get_string("CustomSoundFlesh")  : "Lasgun_Shoot.ogg";
            const string S_OBJECT_HIT = gunBlob.exists("CustomSoundObject") ? gunBlob.get_string("CustomSoundObject") : "Lasgun_Shoot.ogg";
                        ...
                        default:
                        {
                            ...
                            if (blob.hasTag("flesh") || blob.isCollidable() || blob.hasTag("vehicle"))
                            {
                                ...
                                if (blob.getTeamNum() == gunBlob.getTeamNum() && !blob.getShape().isStatic()) continue;
                                         ...
                                         blob.hasTag("food")   || blob.isAttachedTo(hoomanShooter)) continue;
